...
print len(dCoin)
print('theta:'+str(min(dCoin[:,0]))+','+str(max(dCoin[:,0])))
print('phi:'+str(min(dCoin[:,1]))+','+str(max(dCoin[:,1])))

# Generate figures
ax1 = plt.subplot(121)
ax1.hist(dCoin[:,0], bins=20)
ax1.set_xlim((70,110))
...
plt.suptitle('SNAKE Angular Acceptance Histograms: '
