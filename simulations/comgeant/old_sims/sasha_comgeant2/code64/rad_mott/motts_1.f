...
****      DATA E11 /.1, .2, .3, .4, .5, .6, .7, .76, .78 /
      NPOINT=5000
      FMMEV=197.327053
      WE=0.511E-3
****      E0=0.8
****      E1=0.0
****      TANANG=SQRT(2.*WE/(E0+WE))
****      CTT=COS(14.*3.14159/180.)
...
C         E0=E00(N)
         ...
         TANANG=SQRT(2.*WE/(E0+WE))
         tanang=tanang*1.
         ANGDEG=ATAN(TANANG)*180./3.14159
         angrad=angdeg*3.14159/180.
         CTT=1./SQRT(1.+TANANG**2)
C         E1=0.5*(E0+WE)
         eloss=REAL(n)/REAL(nnt)
C         E1=(E0+WE)*eloss
         E1=E0*eloss
****      E1=E11(N)
         CALL RTAIL(E0,E1,CTT,ZAT,AAT,NPOINT,SIG)
***
C     GET THE CROSS SECTION IN 'mbarn/ster/MeV'
***
         SIGMA=10.0*SIG/FMMEV
****       E1MEV=1000.*E1
****       PRINT 1000,E1MEV,SIGMA
**** 1000 FORMAT(5X,'E1 =',E13.5,'  MeV',5X,
****     * 'SIGMA =', E13.5,'  mbarn/ster/MeV')
         E0MEV=1000.*E0
C         WRITE(6,1500) eloss,angrad,SIGMA
 1500    FORMAT(3E13.5)
         PRINT 1000,E0MEV,eloss,ANGDEG,angrad,SIGMA
 1000    FORMAT(5X,'E0 =',E13.5,'  MeV',4X,'E left=',E10.4
     +    ,5X,'theta =',E13.5,' deg'
     *    ,3X,E10.4,5X,'SIGMA =', E13.5,'  mbarn/ster/MeV')
 100  CONTINUE
      END
C
      ...
      DIMENSION A(2),B(2)
      DIMENSION F(0:10000)
      REAL*4 E0,E1,CTT,ZAT,AAT,SIGMA,UX,VX
*
